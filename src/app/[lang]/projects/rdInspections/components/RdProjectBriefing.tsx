    ...
    <div id="projectBriefing" className="grid w-full place-items-center pt-14">
      <ProjectBriefing.Root>
        <ProjectBriefing.Content>
          ...
          <List.Content>
            <List.Item>
              The overall Client Journey, evaluating the entire client
              experience.
            </List.Item>
            <List.Item>
              Identification of the primary issues within the inspection
              process.
            </List.Item>
          </List.Content>
          <Paragraph>
          ...
          <Paragraph>
            ...
            only after its approval, we started to create the main classes, data
