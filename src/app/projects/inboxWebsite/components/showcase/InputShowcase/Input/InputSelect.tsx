  ...
  return (
    ...
    >
      <div className={twMerge('relative', className)}>
        <Select.Trigger
          className={twMerge(
            'relative h-14 w-full border border-[#ebf6f3] bg-gray-100 text-[#062e24]',
            'flex items-center justify-between pr-4 font-semibold',
            'shadow-lg shadow-dark/20 outline-none',
            'hover:bg-[#ebf6f3] focus:bg-[#ebf6f3]',
      ...
      <Select.Portal>
        <Select.Content
          ...
          align="end"
          className={twMerge(
            'z-50 w-full bg-gray-100 shadow-lg shadow-dark/20',
          ...
          <Select.Viewport className="max-h-52 ">
            {options.map((option, i) => (
              <Select.Item
                ...
                value={option}
                className="
                  flex cursor-pointer items-center justify-center gap-3 px-8 text-[#062e24]
                  outline-none focus:bg-[#ebf6f3] data-[isFirstOne=true]:opacity-20
                "
              >
                <div
                  data-isfirst={i === 0}
